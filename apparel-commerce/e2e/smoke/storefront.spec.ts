...
import { skipUnlessProductExists } from "../helpers/api";
...
test.describe("storefront smoke", () => {
  ...
  test("checkout page loads and shows empty bag by default", async ({ page }) => {
  ...
  test("product PDP loads for classic-shorts", async ({ page, request }) => {
    await skipUnlessProductExists(request, "classic-shorts");
    await page.goto("/shop/classic-shorts");

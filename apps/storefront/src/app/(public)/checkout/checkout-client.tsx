  ...
  return (
    <main className="storefront-page-shell motion-surface max-w-4xl">
      ...
      <p className="font-body text-on-surface-variant mb-12 max-w-lg">
        Review your bag. Choose a payment method below. Availability and totals
        are confirmed on the server when you continue to payment.
      </p>
        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <p className="text-xs text-on-surface-variant mt-2">
              1 point equals 1.00 off the cart total. Balance is checked on Medusa before payment.
            </p>
          </section>

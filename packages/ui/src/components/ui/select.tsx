...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        "relative z-50 max-h-96 min-w-[8rem] overflow-hidden rounded-md border border-outline-variant/25 bg-surface-container-lowest text-on-surface shadow-md data-[state=open]:animate-none",
        position === "popper" &&
